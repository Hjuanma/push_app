...
void _pushMessageSerialize(
  ...
  writer.writeDateTime(offsets[3], object.sentDate);
...
PushMessage _pushMessageDeserialize(
  ...
  final object = PushMessage(
    ...
    sentDate: reader.readDateTime(offsets[3]),
...
extension PushMessageQueryWhereSort
  ...
  QueryBuilder<PushMessage, PushMessage, QAfterWhere> anyId() {
...
extension PushMessageQueryWhere
  ...
  QueryBuilder<PushMessage, PushMessage, QAfterWhereClause> idEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PushMessage, PushMessage, QAfterWhereClause> idGreaterThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PushMessage, PushMessage, QAfterWhereClause> idLessThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<PushMessage, PushMessage, QAfterWhereClause> idBetween(
    Id lowerId,
    Id upperId, {
...
extension PushMessageQueryWhereDistinct
  ...
  QueryBuilder<PushMessage, PushMessage, QDistinct> distinctByMessageId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PushMessage, PushMessage, QDistinct> distinctBySentDate() {
    return QueryBuilder.apply(this, (query) {
...
extension PushMessageQueryProperty
  ...
  QueryBuilder<PushMessage, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PushMessage, String, QQueryOperations> messageIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'messageId');
    });
  }

  QueryBuilder<PushMessage, DateTime, QQueryOperations> sentDateProperty() {
    return QueryBuilder.apply(this, (query) {
